...
//    sb.append(" /*041*/      }                                                        \n");
//    sb.append(" /*042*/  }                                                            \n");
    sb.append(" /*043*/ class Xxx{ var xxx:int; func fn(){} } class C { func fn(a:int)->Xxx{} var field:int; var other:Xxx;                                              \n");
    sb.append(" /*044*/      func test() { let z:int; z = other.fn();                   \n");
//    sb.append(" /*045*/           let list: List<[2:[3:int]]> = new List<[2:[3:int]]>();               \n");
...
//    sb.append(" /*048*/          list.append(value: 3);                               \n");
    ...
    DumpExpression dumpExpression = new DumpExpression(instantiationUnit.getClasses().get(1).getMethods().get(1)
        .getBlock().getBlockStatements().get(1).getStatement().getSexpression());
    System.out.println(dumpExpression.getSb());
