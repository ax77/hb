...
public class ParseIntLiteralAgain {

  private void cutForBase(LinkedList<Character> buffer, StringBuilder out, int base) {
  ...
  private char cutMntExp(LinkedList<Character> buffer, StringBuilder mnt, StringBuilder exp, int mntBase) {
  ...
  class IntLiteralInfo {
    ...
    public IntLiteralInfo(String originalInput, char mainSign, String dec, String mnt, String exp, String suf,
        char exponentSign) {
  ...
  private String parse(String string) {
    ...
    for (char c : string.toCharArray()) {
      ...
      if (!charIsOk) {
        throw new RuntimeException("not a number: " + string);
      }
    ...
    return main_sign + dec.toString() + "|" + mnt.toString() + "|" + (exp.length() == 0 ? "" : exp_sign)
        + exp.toString() + "|" + suf.toString();
  }

  private LinkedList<Character> strToList(String what) {
  ...
  private long evalLong(int base, String dec) {
  ...
  private double evaldecfloat(String dec, String mnt, String exp, String sig) {
  ...
  private double evalhexfloat(String dec, String mnt, String exp, String sig) {
