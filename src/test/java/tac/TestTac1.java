...
public class TestTac1 {
  ...
  public void testTac() throws IOException {
    ...
    sb.append("    int e = a + b + c;                                  //049 \n");
    sb.append("    int f = x1.getX();                                  //050 \n");
    sb.append("    int g = x2.getValue().getX();                       //051 \n");
    sb.append("    if(a == 0) {                                        //052 \n");
    sb.append("      b += 1;                                           //053 \n");
    sb.append("    } else if(b == 1) {                                 //054 \n");
    sb.append("      c += 2;                                           //055 \n");
    sb.append("    } else {                                            //056 \n");
    sb.append("      e = 32;                                           //057 \n");
    sb.append("    }                                                   //058 \n");
    sb.append("    for(int j = 0; j < 8; j += 1) {                     //059 \n");
    sb.append("      e += 2;                                           //060 \n");
    sb.append("      a -= 1;                                           //061 \n");
    sb.append("      if(a == 1) {                                      //062 \n");
    sb.append("        break;                                          //063 \n");
    sb.append("      }                                                 //064 \n");
    sb.append("      if(j == 2) {                                      //065 \n");
    sb.append("        continue;                                       //066 \n");
    sb.append("      }                                                 //067 \n");
    sb.append("    }                                                   //068 \n");
    sb.append("  }                                                     //069 \n");
    sb.append("}                                                       //070 \n");
